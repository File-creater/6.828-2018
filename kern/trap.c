...
trap_init(void)
{
	...
	void DivideZeroHandler();
	void DebugHandler();
	void NMIHandler();
	void BrkptHandler();
	void OverflowHandler();
	void BREHandler();
	void InvalidOpHandler();
	void DNAHandler();
	void DFHandler();
...
/* #define T_RES    15   reserved */
    ...
    SETGATE(idt[T_BOUND], 0, GD_KT, BREHandler, 0);
    SETGATE(idt[T_ILLOP], 0, GD_KT, InvalidOpHandler, 0);
    SETGATE(idt[T_DEVICE], 0, GD_KT, DNAHandler, 0);
    SETGATE(idt[T_DBLFLT], 0, GD_KT, DFHandler, 0);
    /* #define T_COPROC  9 */   // reserved (not generated by   recent processors)
    ...
    SETGATE(idt[T_GPFLT], 0, GD_KT, GPHandler, 0);
    SETGATE(idt[T_PGFLT], 0, GD_KT, PFHandler, 0);
    /* #define T_RES    15 */   // reserved
    SETGATE(idt[T_FPERR], 0, GD_KT, FEHandler, 0);
    SETGATE(idt[T_ALIGN], 0, GD_KT, AlignHandler, 0);
    SETGATE(idt[T_MCHK], 0, GD_KT, MachineHandler, 0);
